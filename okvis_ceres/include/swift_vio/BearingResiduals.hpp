#ifndef INCLUDE_SWIFT_VIO_BEARING_RESIDUALS_HPP_
#define INCLUDE_SWIFT_VIO_BEARING_RESIDUALS_HPP_
#include <Eigen/Core>
#include <memory>
...
#include <swift_vio/ceres/corrector.h>
...
class BearingResiduals {
 public:
  ...
  void correct(Eigen::Vector3d* residual,
    ...
    swift_vio::ceres::internal::Corrector correct(squared_norm, rho);
...
#endif  // INCLUDE_SWIFT_VIO_BEARING_RESIDUALS_HPP_
